...
SCHEMA = vol.Schema({
    vol.Required(CONF_NODE_PREFIX): str,   # e.g. "pillbox"
...
class MellowPillConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input: dict[str, Any] | None = None) -> FlowResult:
        ...
        # store everything in options so you can edit later
        return self.async_create_entry(title="Mellow_labs Pill Dispenser", data={}, options=user_input)
